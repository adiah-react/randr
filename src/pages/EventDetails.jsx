...
export function EventDetails() {
  ...
  // Determine if the reception should be visible at all
  // Hide completely for ceremony-only guests so they don't know it exists
      ...
      <div className="pt-24 pb-24">
        <div className="max-w-6xl mx-auto px-6">
          {showReception /* Two-column layout when reception is visible */ ? (
            ...
            </div> /* Single centered layout for ceremony-only guests */
          ) : (
          ...
          >
            ...
            <p className="text-gray-600 text-lg font-light mb-8">
              {isCeremonyOnly
                ...
                : "Black Tie Optional. We ask that men wear tuxedos or dark suits and women wear evening gowns or cocktail dresses."}
