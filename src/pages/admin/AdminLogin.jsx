    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-wedding-black text-white rounded-full flex items-center justify-center mx-auto mb-4">
            <Lock size={24} />
          </div>
          <h1 className="text-2xl font-serif text-wedding-black">
            Admin Access
          </h1>
