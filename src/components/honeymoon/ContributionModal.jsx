...
export function ContributionModal({ isOpen, onClose, item, onSubmit }) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full p-3 border border-gray-200 rounded-sm focus:outline-none focus:border-wedding-gold focus:ring-1 focus:ring-wedding-gold transition-colors resize-none"
