        ...
        <div className="hidden md:flex items-center space-x-8">
          {allLinks.map((link) => (
            ...
            >
              {link.name}
              <span
                className={`absolute -bottom-1 left-0 w-0 h-0.5 transition-all duration-300 group-hover:w-full ${scrolled || !isDarkBg ? "bg-wedding-black" : "bg-white"}`}
              ></span>
            </Link>
          ))}
          ...
          <div
            className={`h-4 w-px ${scrolled || !isDarkBg ? "bg-gray-300" : "bg-white/30"}`}
          ></div>
          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span className="uppercase tracking-wide lg:hidden">Guest</span>
              </Link>
              <button
            ...
            <div className="flex items-center space-x-4">
              <Link
                to="/invite"
                className={`text-sm uppercase tracking-widest font-medium border px-4 py-2 transition-all duration-300 ${scrolled || !isDarkBg ? "border-wedding-black text-wedding-black hover:bg-wedding-black hover:text-white" : "border-white text-white hover:bg-white hover:text-black"}`}
              >
                Guest Access
              </Link>
