    ...
    >
      ...
      <div className="space-y-4">
        <label className="flex items-center space-x-3 cursor-pointer group">
          <div
            className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${status === "attending" ? "border-wedding-gold bg-wedding-gold" : "border-gray-300 group-hover:border-wedding-gold"}`}
          >
            {status === "attending" && (
          ...
          <span
            className={`text-lg font-light ${status === "attending" ? "text-wedding-black font-medium" : "text-gray-600"}`}
          >
            Joyfully Accepts
          </span>
        </label>
        ...
        <label className="flex items-center space-x-3 cursor-pointer group">
          <div
            className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${status === "declined" ? "border-wedding-black bg-wedding-black" : "border-gray-300 group-hover:border-wedding-black"}`}
          >
            {status === "declined" && (
              <div className="w-2 h-2 bg-white rounded-full" />
            )}
          ...
          <span
            className={`text-lg font-light ${status === "declined" ? "text-wedding-black font-medium" : "text-gray-600"}`}
          >
